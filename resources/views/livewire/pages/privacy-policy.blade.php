<div>
    ...
    @section('titles')
        <title>Quadrant Luxury Ocean Living - {{__('Aviso de Privacidad')}}</title>
    @endsection
        ...
        <div class="position-absolute bottom-0 start-0 row justify-content-center justify-content-lg-start">
            ...
            <div class="col-12 col-lg-8 col-xxl-4 px-0 position-relative">
                ...
                <div class="position-absolute start-0 top-0 pt-3 ps-3 pt-lg-5 ps-lg-5 w-100">
                    <h1 class="mb-5 mt-5 mt-lg-3 text-uppercase">{{__('Aviso de Privacidad')}}</h1>
                </div>
            </div>

        </div>

        <img src="{{asset('img/inventory-img.webp')}}" alt="Quadrant Luxury Ocean Living" class="w-100 object-fit-cover" style="height: 33vh; object-position:bottom;">
            ...
            @else
                <article>
                    ...
                    <h2>CAMBIOS AL AVISO DE PRIVACIDAD</h2>
                        ...
                        <a href="https://punto401.com/">Sitio web por Punto401 Marketing</a>

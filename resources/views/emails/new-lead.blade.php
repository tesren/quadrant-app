...
<html lang="es">
    ...
    <head>
        ...
        <title>Mensaje del sitio web de Quadrant Luxury Ocean Living</title>
    </head>

    <body>
        <p>
            Mensaje recibido del sitio web de Quadrant Luxury Ocean Living
        </p>
        ...
        <p>Este mensaje fue enviado desde un formulario de contacto en el sitio web de Quadrant Luxury Ocean Living</p>
